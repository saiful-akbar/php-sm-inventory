		...
		<ul class="collapsible popout" data-collapsible="accordion">
			...
			<li>
				...
				<div class="collapsible-body white">
					<form method="POST" action="<?= BASEURL; ?>/Return_penjualan/tambah" autocomplete="off">
						<div class="row">
			...
			<li>
				...
				<div class="collapsible-body white">
					<form method="POST" action="<?= BASEURL; ?>/Return_penjualan/simpan">
						<div class="row">
							<div class="input-field col s12">
								<label for="no_transaksi">No. Retun Penjualan</label>
								<input type="text" name="no_return_penjualan" id="no_return_penjualan" class="validate" value="<?= $data['no_return_penjualan']; ?>" readonly="" required="">
							</div>
						</div>
						<div class="row">
							<div class="col s12">
...
<form name="formTable" method="POST" action="<?= BASEURL; ?>/Return_penjualan/hapus">
	<div class="row">
		<div id="man" class="col s12">
			<div class="card material-table">
				<div class="table-header">
					<span class="table-title">List Return Penjualan Barang</span>
					<div class="actions">
				...
				<table class="datatable" width="100%">
					...
					<tbody>
						<?php foreach ($data['return_penjualan_list'] as $index => $list): ?>
							<tr>
								<td width="1">
