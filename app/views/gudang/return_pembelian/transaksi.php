		...
		<ul class="collapsible popout" data-collapsible="accordion">
			...
			<li>
				...
				<div class="collapsible-body white">
					<form method="POST" action="<?= BASEURL; ?>/Return_pembelian/tambah" autocomplete="off">
						<div class="row">
			...
			<li>
				...
				<div class="collapsible-body white">
					<form method="POST" action="<?= BASEURL; ?>/Return_pembelian/simpan">
						<div class="row">
							<div class="input-field col s12 m12">
								<label for="no_transaksi">No. Retun Pembelian</label>
								<input type="text" name="no_return_pembelian" id="no_return_pembelian" class="validate" value="<?= $data['no_return_pembelian']; ?>" readonly="" required="">
							</div>
						</div>
						<div class="row">
						...
						<div class="row">
							<div class="input-field col s12 m12">
								...
								<label for="keterangan">Keterangan <span class="red-text">*</span></label>
							</div>
						</div>
						<div class="row">
...
<form name="formTable" method="POST" action="<?= BASEURL; ?>/Return_pembelian/hapus">
	<div class="row">
		<div id="man" class="col s12">
			<div class="card material-table">
				<div class="table-header">
					<span class="table-title">List Return Pembelian Barang</span>
					<div class="actions">
				...
				<table class="datatable" width="100%">
					...
					<tbody>
						<?php foreach ($data['return_pembelian_list'] as $index => $list): ?>
							<tr>
								<td width="1">
