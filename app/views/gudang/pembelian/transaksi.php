		...
		<ul class="collapsible popout" data-collapsible="accordion">
			...
			<li>
				...
				<div class="collapsible-body white">
					<form method="POST" action="<?= BASEURL; ?>/Pembelian/tambah" autocomplete="off">
						<div class="row">
							<div class="input-field col s12">
								<a href="#modal-barang" class="material-icons input-icon cyan-text waves-effect waves-dark modal-trigger tooltipped" data-delay="50" data-position="top" data-tooltip="Cari Tabel">
									insert_invitation
								</a>
						...
						<div class="row">			
							...
							<div class="input-field col s12 m6">
								<input type="number" name="harga_beli" id="harga_beli" class="validate" readonly=""/>
			...
			<li>
				...
				<div class="collapsible-body white">
					<form method="POST" action="<?= BASEURL; ?>/Pembelian/simpan">
						<div class="row">
							<div class="input-field col s12 m12">								
								<label for="no_transaksi">No. Pembelian</label>
								<input type="text" name="no_pembelian" id="no_pembelian" class="validate" value="<?= $data['no_pembelian']; ?>" readonly="" required="">
							</div>
						</div>
						<div class="row">
						...
						<div class="row">
							<div class="input-field col s12 m12">
								...
								<label>Supplier <span class="red-text">*</span></label>
							</div>
						</div>
						<div class="row">
...
<!-- tabel list barang pembelian -->
<form name="formTable" method="POST" action="<?= BASEURL; ?>/Pembelian/hapus">
	<div class="row">
		<div id="man" class="col s12">
			<div class="card material-table">
				<div class="table-header">
					<span class="table-title">List Pembelian Barang</span>
					<div class="actions">
						<a class="btn-flat waves-effect nopadding tooltipped" data-delay="50" data-position="top" data-tooltip="Hapus" id="multi-hapus-data">
				...
				<table class="datatable" width="100%">
					...
					<tbody>
						<?php foreach ($data['list_pembelian'] as $index => $list): ?>
							<tr>
								<td width="1">
